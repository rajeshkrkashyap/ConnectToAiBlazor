...
namespace ConnectToAi.MobileApp.UtilityClasses
{
    public class SpeachRecognition
    {
        ...
        public static async Task<string> ContinuousRecognitionWithFileAsync(string audioFilePath)
        {
        ...
        public static async Task<string> SpeechRecognitionWithCompressedInputPullStreamAudio(Stream audioStream)
        {
        ...
        //    {
        //        using (var recognizer = new Microsoft.CognitiveServices.Speech.SpeechRecognizer(config, autoDetectSourceLanguageConfig, audioInput))
        //        {
        //            // Subscribes to events.
        //            recognizer.Recognizing += (s, e) =>
        //            {
        ...
        //    // Creates a speech recognizer for the specified language, using microphone as audio input.
        //    using (var recognizer = new Microsoft.CognitiveServices.Speech.SpeechRecognizer(config, language))
        //    {
        //        while (true)
        //        {
        ...
        //    using (var Microsoft.CognitiveServices.Speech.SpeechRecognizer = new Microsoft.CognitiveServices.Speech.SpeechRecognizer(speechConfig, "en-US", audioConfig))
        //    {
        //        // create pronunciation assessment config, set grading system, granularity and if enable miscue based on your requirement.
        ...
        //        pronAssessmentConfig.ApplyTo(Microsoft.CognitiveServices.Speech.SpeechRecognizer);

        //        audioInputStream.Write(audioData);
        //        audioInputStream.Write(new byte[0]); // send a zero-size chunk to signal the end of stream

        //        var result = await Microsoft.CognitiveServices.Speech.SpeechRecognizer.RecognizeOnceAsync().ConfigureAwait(false);
        ...
        //        using (var recognizer = new Microsoft.CognitiveServices.Speech.SpeechRecognizer(config, language, audioInput))
        //        {
        ...
        //    using (var recognizer = new Microsoft.CognitiveServices.Speech.SpeechRecognizer(config, language, audioConfig))
        //    {
        //        // Starts recognizing.
        //        pronunciationConfig.ApplyTo(recognizer);
